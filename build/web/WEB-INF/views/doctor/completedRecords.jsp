                                    ...
                                    <c:forEach var="r" items="${completedRecords}">
                                        <tr data-search="${r.healthRecordId} ${r.patientName} ${r.finalDiagnosis}">
                                            ...
                                            <td class="text-end text-nowrap">
                                                <a class="btn btn-sm btn-doctor" href="${pageContext.request.contextPath}/doctor/records/detail?record_id=${r.healthRecordId}"><i class="bi bi-pencil-square"></i> Chỉnh sửa</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                                        ...
                                        <tr>
                                                ...
                                                <c:choose>
                                                    <c:when test="${lab.hasMeasurements}">
                                                        <small class="doctor-muted">
                                                            ...
                                                            <c:if test="${not empty lab.ldl}">LDL: ${lab.ldl} · </c:if>
                                            ...
                                            <td class="text-end">
                                                <a class="btn btn-sm btn-outline-primary"
                                                   href="${pageContext.request.contextPath}/doctor/records/detail?record_id=${lab.healthRecordId}">
