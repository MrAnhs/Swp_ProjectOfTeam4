...
public class AIConversationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (conversationId == null || conversationId.trim().isEmpty()) {
            ...
            response.getWriter().print("{\"error\":\"Missing conversation ID\"}");
            return;
        }
        ...
        try {
            ...
            response.setStatus(400);
            response.getWriter().print("{\"error\":\"Invalid conversation ID\"}");
            return;
        }
        ...
        // Only return a conversation owned by the patient account in the session.
        String sql = "SELECT c.conversation_id, c.patient_id, c.chat_history, c.ai_summary, c.created_at " +
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                result.put("summary", rs.getString("ai_summary"));
                ...
                response.getWriter().print("{\"error\":\"Conversation not found\"}");
                return;
            }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            json.append("\"summary\":\"").append(escJson((String)result.get("summary"))).append("\",");
    ...
    private List<Map<String, Object>> parseConversationHistory(String history) {
        ...
        // Simple parsing: split by user/AI markers
        // Format: "User: message\nAI: reply\nUser: message2..."
