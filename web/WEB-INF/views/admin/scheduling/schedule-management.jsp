                                        ...
                                        <div class="col-lg-9 admin-content-col">
                                            ...
                                            <div
                                                ...
                                                <div class="btn-group p-1 bg-white border rounded-pill shadow-sm"
                                                    ...
                                                    <button type="button" id="viewModeCalendarBtn"
                                                        class="btn btn-sm rounded-pill px-3 py-1 fw-bold text-white"
                                                        style="font-size: 0.88rem; background-color: #7c3aed; transition: all 0.2s;">
                                                        <i class="fa-solid fa-calendar-week me-1"></i>📅 Lịch theo tuần
                                                    </button>
                                                    <button type="button" id="viewModeListBtn"
                                                        class="btn btn-sm rounded-pill px-3 py-1 fw-semibold text-secondary bg-transparent"
                                                        style="font-size: 0.88rem; transition: all 0.2s;">
                                            ...
                                            <div class="card border-0 shadow-sm mb-3" style="border-radius: 16px;">
                                                <div class="card-body p-3">
                                                    <form id="unifiedFilterForm" method="GET"
                                                        action="${pageContext.request.contextPath}/admin"
                                                        class="row g-2 align-items-center">
                                                        <input type="hidden" name="action" value="schedule">
                                                        <input type="hidden" id="selectedViewTab" name="viewTab"
                                                            value="calendar">

                                                        <!-- Vai trò -->
                                                        <div class="col-md-2" id="unifiedRoleFilterContainer">
                                                            <label
                                                                class="form-label text-secondary small fw-bold mb-1">Vai
                                                                trò</label>
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" id="unifiedSearchInput" name="search"
                                                                    ...
                                                                    placeholder="Tên nhân sự..." value="${param.search}"
                                                        ...
                                                        <div class="col-md-1 d-flex align-items-end gap-1"
                                                            ...
                                                            <button type="button" id="unifiedFilterResetBtn"
                                                                class="btn btn-sm btn-outline-secondary py-1"
                                                                style="border-radius: 8px;" title="Đặt lại">
                                            ...
                                            <div class="tab-content" id="scheduleRoleTabContent">
                                                ...
                                                <div class="schedule-role-pane" id="detailedListPane"
                                                    style="display: none;">
                                                    <!-- Bộ 3 Tab Role chuyên nghiệp 1-Click cho chế độ Danh sách chi tiết -->
                                                    <div id="detailedListRoleSwitch"
                                                        class="card border-0 shadow-sm p-2 mb-3 bg-white"
                                                        style="border-radius: 12px;">
                                                        <div
                                                            class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                            <span class="fw-bold text-dark small ms-2"><i
                                                                    class="fa-solid fa-users-gear me-2 text-primary"></i>Chọn
                                                                vai trò nhân sự:</span>
                                                            <div class="btn-group p-1 bg-light rounded-pill border"
                                                                role="group">
                                                                <button type="button"
                                                                    class="btn btn-sm rounded-pill px-3 py-1 fw-bold detailed-role-tab active text-white bg-primary"
                                                                    data-role="Doctor"
                                                                    style="font-size: 0.86rem; transition: all 0.2s;">
                                                                    <i class="fa-solid fa-user-doctor me-1"></i>🩺 Bác
                                                                    sĩ khám
                                                                </button>
                                                                <button type="button"
                                                                    class="btn btn-sm rounded-pill px-3 py-1 fw-semibold text-secondary bg-transparent detailed-role-tab"
                                                                ...
                                                                <button type="button"
                                                                    class="btn btn-sm rounded-pill px-3 py-1 fw-semibold text-secondary bg-transparent detailed-role-tab"
                                                                    data-role="doctor_lab"
                                                                    style="font-size: 0.86rem; transition: all 0.2s;">
                                                                    <i class="fa-solid fa-flask-vial me-1"></i>🧪 Bác sĩ
                                                                    xét nghiệm
                                                                </button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <%@ include
                                                        file="/WEB-INF/views/admin/scheduling/includes/doctor-role-pane.jsp"
                                                        %>
                                                        <%@ include
                                                ...
                                                <div class="schedule-role-pane" id="weeklyCalendarPane">
                                                    ...
                                                    <div id="calendarConflictAlert"
                                                        ...
                                                        <div class="d-flex align-items-center gap-2">
                                                            <i
                                                                class="bi bi-exclamation-triangle-fill fs-5 text-danger me-1"></i>
                                                            <span id="calendarConflictSummaryText"
                                                                class="fw-semibold">Phát hiện xung đột trùng ca hoặc
                                                                trùng phòng làm việc! Thẻ bị trùng đang được khoanh viền
                                                                đỏ ⚠</span>
                                                        </div>
                                                        <button type="button"
                                                            class="btn btn-sm btn-danger fw-bold px-3 py-1"
                                                            onclick="openResolveConflictModal()"
                                                            style="border-radius: 8px;">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            Sáng<br><small
                                                                                class="text-muted fw-normal">07:00 -
                                                                                11:30</small>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            Chiều<br><small
                                                                                class="text-muted fw-normal">13:30 -
                                                                                17:30</small>
                                                                        </td>
                                            ...
                                            <div class="modal fade" id="transferScheduleModal" tabindex="-1"
                                                aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select id="transferTargetDoctor"
                                            ...
                                            <div id="aiScheduleLoading"
                                                ...
                                                <span class="spinner-grow spinner-grow-sm text-purple"
