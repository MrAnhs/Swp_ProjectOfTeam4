                                ...
                                <div
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="button" id="createScheduleToolbarBtn"
                                            ...
                                            data-bs-target="#createScheduleModal">Tạo ca bác sĩ</button>
                                    </div>
                                </div>
                                ...
                                <div class="role-switch-card schedule-role-tabs mb-3">
                                    <ul class="nav nav-pills role-tabs" id="scheduleRoleTabs" role="tablist">
                                        <li class="nav-item flex-fill" role="presentation">
                                            <button class="nav-link active w-100 schedule-role-tab" id="doctor-role-tab"
                                                data-role-target="#doctorRolePane" type="button" role="tab">
                                                <i class="bi bi-heart-pulse me-2"></i>Bác sĩ khám
                                                <small>Lịch bác sĩ khám, suất đặt online và tải bệnh nhân</small>
                                            </button>
                                        </li>
                                        <li class="nav-item flex-fill" role="presentation">
                                            <button class="nav-link w-100 schedule-role-tab" id="receptionist-role-tab"
                                                data-role-target="#receptionistRolePane" type="button" role="tab">
                                                <i class="bi bi-person-badge me-2"></i>Lễ tân
                                                <small>Lịch nhân sự tại quầy tiếp nhận</small>
                                            </button>
                                        </li>
                                        <li class="nav-item flex-fill" role="presentation">
                                            <button class="nav-link w-100 schedule-role-tab" id="lab-role-tab"
                                                data-role-target="#labRolePane" type="button" role="tab">
                                                <i class="bi bi-clipboard2-pulse me-2"></i>Bác sĩ xét nghiệm
                                                <small>Lịch nhân sự tại phòng xét nghiệm</small>
                                            </button>
                                        </li>
                                        <li class="nav-item flex-fill" role="presentation">
                                            <button class="nav-link w-100 schedule-role-tab text-purple"
                                                id="weekly-calendar-tab" data-role-target="#weeklyCalendarPane"
                                                type="button" role="tab">
                                                <i class="bi bi-calendar-week me-2 text-purple"></i>Lịch theo tuần
                                                (Weekly Calendar)
                                                <small>Tổng quan ca làm việc toàn bộ nhân sự theo tuần</small>
                                            </button>
                                        </li>
                                    </ul>
                                </div>
