...
<body class="bg-light d-flex align-items-center justify-content-center" style="min-height:100vh;background:linear-gradient(135deg,#f4fbf9 0%,#e8f7f4 100%);">
                ...
                <div class="card login-card border-0 shadow-lg p-3 bg-white">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="${pageContext.request.contextPath}/auth" method="post" class="needs-validation" novalidate>
                            <div class="mb-3">
                                ...
                                <div class="input-group custom-input-group">
                                    ...
                                    <input type="email" class="form-control border-start-0 ps-0 shadow-none" id="email" name="email" placeholder="tenban@example.com" autocomplete="email" required>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group custom-input-group">
                                    ...
                                    <input type="password" class="form-control border-start-0 ps-0 shadow-none" id="password" name="password" placeholder="**********" autocomplete="current-password" required>
                            ...
                            <div class="d-flex justify-content-end align-items-center mb-4 pt-1">
                                <a href="${pageContext.request.contextPath}/forgot-password/" class="text-decoration-none text-secondary small link-hover-vinmec">Quên mật khẩu?</a>
                            </div>
                        ...
                        <p class="text-center text-secondary mt-4 mb-0 small">
                            Chưa có tài khoản? <a href="${pageContext.request.contextPath}/register.jsp" class="text-decoration-none fw-bold text-dark link-hover-vinmec">Đăng ký</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script charset="UTF-8" src="${pageContext.request.contextPath}/assets/js/pages/public/login.js?v=20260715-login1"></script>
</body>
</html>
