...
<aside class="doctor-sidebar">
    ...
    <nav class="doctor-nav">
        ...
        <a class="active" href="${pageContext.request.contextPath}/PatientSearchServlet"><i class="bi bi-search"></i> Tra cứu</a>
...
<main class="doctor-main">
    ...
    <section class="doctor-card mb-4">
        <form action="${pageContext.request.contextPath}/PatientSearchServlet" method="get">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a class="btn btn-sm btn-doctor"
                                           href="${pageContext.request.contextPath}/DetailServlet?record_id=${record.healthRecordId}">
