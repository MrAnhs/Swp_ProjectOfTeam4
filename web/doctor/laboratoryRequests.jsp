...
<aside class="doctor-sidebar">
    ...
    <nav class="doctor-nav">
        ...
        <a class="active" href="${pageContext.request.contextPath}/LaboratoryListServlet"><i class="bi bi-eyedropper"></i> Xét nghiệm</a>
...
<main class="doctor-main">
    <section class="doctor-topbar mb-4">
        <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 align-items-lg-center">
            ...
            <form class="d-flex gap-2" method="get" action="${pageContext.request.contextPath}/LaboratoryListServlet">
                            ...
                            <tr>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <div class="small doctor-muted">
                                                ...
                                                <c:if test="${not empty lab.idl}">LDL: <strong>${lab.idl}</strong> · </c:if>
                                ...
                                <td class="text-end">
                                    <a class="btn btn-sm btn-outline-primary"
                                       href="${pageContext.request.contextPath}/DetailServlet?record_id=${lab.healthRecordId}">Mở hồ sơ</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
