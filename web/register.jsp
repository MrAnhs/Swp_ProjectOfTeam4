                ...
                <div class="card border-0 shadow-lg overflow-hidden" style="border-radius: 20px;">
                    <div class="row g-0">
                        <div class="col-md-4 p-4 text-white d-flex flex-column justify-content-center text-center text-md-start" style="background-color: #2dbbbc;">
                            <div class="mb-3"><i class="bi bi-heart-pulse-fill" style="font-size: 3rem;"></i></div>
                            <h3 class="fw-bold mb-3">Tạo tài khoản</h3>
                            <p class="small opacity-90 mb-0">Đăng ký hồ sơ bệnh nhân an toàn và sử dụng các công cụ hỗ trợ chăm sóc sức khỏe.</p>
                        </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group custom-input-group">
                                            ...
                                            <div class="invalid-feedback ms-3" id="dobFeedback">Vui lòng nhập ngày sinh hợp lệ và không ở tương lai.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group custom-input-group">
                                            ...
                                            <div class="invalid-feedback ms-3">Vui lòng nhập số di động Việt Nam hợp lệ, ví dụ 0912345678 hoặc +84912345678.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group custom-input-group">
                                            ...
                                            <input type="text" class="form-control border-start-0 ps-0 shadow-none" id="address" name="address" placeholder="Số nhà, phường/xã, quận/huyện, tỉnh/thành">
                                        </div>
                                    </div>
                                </div>
